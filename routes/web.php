...
// CRUD PERAN
Route::get('/peran', [FilmController::class,'index']);
Route::get('/peran/create', [FilmController::class,'create']);
Route::post('/peran', [FilmController::class,'store']);
Route::get('/peran/{peran_id}/edit', [FilmController::class,'edit']);
Route::put('/peran/{peran_id}', [FilmController::class,'update']);
Route::delete('/peran/{peran_id}', [FilmController::class,'destroy']);